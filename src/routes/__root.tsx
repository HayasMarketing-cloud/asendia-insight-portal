...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Hayas Client Portal" },
      {
        name: "description",
        content:
          "Hayas Marketing client portal — B2B strategic marketing intelligence and Lead Accelerator dashboards.",
      },
      { property: "og:title", content: "Hayas Client Portal" },
      {
